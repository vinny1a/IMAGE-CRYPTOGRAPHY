...
import wave
#WAVE, short for Waveform Audio File Format.
import re
...
def getfile(m,x):
    ...
    #print(imagelocation)
    m.config(text=imagelocation,fg="green")
    x.config(text="",fg="black")
...
def getsave(n,y):
    ...
    n.config(text=savelocation,fg="green")
    y.config(text="",fg="black")
...
def getfile1(a,x):
    ...
    a.config(text=imagelocation1,fg="green")
    x.config(text="",fg="black")
...
def getsave1(b,y):
    ...
    b.config(text=savelocation1,fg="green")
    y.config(text="",fg="black")
...
def getfilev(a,x):
    ...
    #setattr(getfile,'imageloc',filename)
    #print(imagelocation1)
    a.config(text=imagelocationv,fg="green")
    x.config(text="",fg="black")
    #getfile.var=imagelocation1
    #print(getfile.var)
    #return filename
...
def getsavev(b,y):
    ...
    b.config(text=savelocationv,fg="green")
    y.config(text="")
...
def new_encrypt(): # new window definition
    ...
    blank=Label(tab1,text="Choose the image to hide data ",fg="white",bg="grey25").grid(column=0,row=1,padx=10,pady=10)
    selectfile= Button(tab1,text="Choose Image",command= lambda: getfile1(blank1,errlabel),bg="grey25",fg="yellow")
    selectfile.grid(column=1,row=1,padx=10,pady=10)
    blank1=Label(tab1,bg="grey25")
    blank1.grid(column=2,row=1,padx=10,pady=10)
    blank=Label(tab1,text="Choose from storage directory",fg="white",bg="grey25").grid(column=0,row=2,padx=10,pady=10)
    selectfile= Button(tab1,text="Select folder",command= lambda: getsave1(blank2,errlabel),bg="grey25",fg="yellow")
    selectfile.grid(column=1,row=2,padx=10,pady=10)
    blank2=Label(tab1,bg="grey25")
    blank2.grid(column=2,row=2,padx=10,pady=10)
    lable1=Label(tab1,text="Enter the message",fg="white",bg="grey25")
    ...
    lable2=Label(tab1,text="Enter key here",fg="white",bg="grey25")
    ...
    blanka=Label(tab2,text="Choose the Audio to hide data ",fg="white",bg="grey25").grid(column=0,row=1,padx=10,pady=10)
    selectfilea= Button(tab2,text="Choose Audio",command= lambda: getfile(blank1a,errlabela),bg="grey25",fg="yellow")
    selectfilea.grid(column=1,row=1,padx=10,pady=10)
    blank1a=Label(tab2,bg="grey25")
    blank1a.grid(column=2,row=1,padx=10,pady=10)
    blankaud=Label(tab2,text="Choose from storage directory",fg="white",bg="grey25").grid(column=0,row=2,padx=10,pady=10)
    selectfileau= Button(tab2,text="Select folder",command= lambda: getsave(blank2a,errlabela),bg="grey25",fg="yellow")
    selectfileau.grid(column=1,row=2,padx=10,pady=10)
    blank2a=Label(tab2,bg="grey25")
    blank2a.grid(column=2,row=2,padx=10,pady=10)
    lable1a=Label(tab2,text="Enter the message ",fg="white",bg="grey25")
    ...
    lable2a=Label(tab2,text="Enter key here",fg="white",bg="grey25")
    ...
    blankv=Label(tab3,text="Choose the video to hide data",fg="white",bg="grey25").grid(column=0,row=1,padx=10,pady=10)
    selectfilev= Button(tab3,text="Choose video",command= lambda: getfilev(blank1v,errlabelv),bg="grey25",fg="yellow")
    selectfilev.grid(column=1,row=1,padx=10,pady=10)
    blank1v=Label(tab3,bg="grey25")
    blank1v.grid(column=2,row=1,padx=10,pady=10)
    lable1v=Label(tab3,text="Enter the message",fg="white",bg="grey25")
    ...
    lable2v=Label(tab3,text="Enter key here",fg="white",bg="grey25")
...
def new_decrypt(): # new window definition
    ...
    selectfile= Button(tab1,text="choose image",command= lambda: getfile(blank1,errlabel),bg="grey25",fg="yellow")
    selectfile.grid(column=1,row=1,padx=10,pady=10)
    blank1=Label(tab1,bg="grey25")
    blank1.grid(column=2,row=1,padx=10,pady=10)   
    lable2=Label(tab1,text="enter key ",fg="white",bg="grey25")
    ...
    lable1=Label(tab1,text="Decrypted message",fg="white",bg="grey25")
    ...
    selectfilea= Button(tab2,text="choose audio",command= lambda: getfile1(blank1a,errlabela),bg="grey25",fg="yellow")
    selectfilea.grid(column=1,row=1,padx=10,pady=10)
    blank1a=Label(tab2,bg="grey25")
    blank1a.grid(column=2,row=1,padx=10,pady=10)   
    lable2a=Label(tab2,text="enter key here",fg="white",bg="grey25")
    ...
    lable1a=Label(tab2,text="Decrypted message",fg="white",bg="grey25")
    ...
    lable1v=Label(tab3,text="Decrypted message ",fg="white",bg="grey25")
...
button2.config(width=70,height=5,background="blue")
